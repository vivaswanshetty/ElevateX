                                    ...
                                    <div className="flex-[3] flex flex-col border-r border-gray-200 dark:border-white/10">
                                        ...
                                        <div className="p-6 border-b border-gray-200 dark:border-white/10 bg-gradient-to-b from-indigo-500/5 to-transparent">
                                            ...
                                            <div className="flex items-center gap-2 font-bold text-purple-600 dark:text-purple-400">
                                                <div className="p-0.5 bg-purple-500/10 rounded-full border border-purple-500/20">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-zap text-purple-500"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>
                                                </div>

...
const MIGRATION_NAME = 'update_avatars_to_lorelei_2025';
    ...
    try {
        ...
        for (const user of users) {
            ...
            if (!user.avatar || user.avatar.includes('api.dicebear.com')) {
                const newAvatar = `https://api.dicebear.com/7.x/lorelei/svg?seed=${encodeURIComponent(user.email)}`;
        ...
        console.log(`\n🎉 Migration complete!`);
        console.log(`📈 Updated ${updatedCount} users to new Lorelei avatars`);
